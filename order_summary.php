...
<div style="background:var(--color-background-secondary); border-bottom:0.5px solid var(--color-border-tertiary); padding:0.75rem 1.5rem; display:flex; align-items:center; justify-content:center; gap:0;">
  <div style="display:flex; align-items:center; gap:4px;">

    <div style="display:flex; align-items:center; gap:6px; font-size:12px; color:#004cac; font-weight:500;">
      <div style="width:22px;height:22px;border-radius:50%;background:#004cac;display:flex;align-items:center;justify-content:center;font-size:11px;color:#fff;">✓</div>
      Wizard
    </div>
    <div style="width:40px;height:1px;background:#004cac;margin:0 4px;"></div>
    ...
    <div style="display:flex; align-items:center; gap:6px; font-size:12px; color:#004cac; font-weight:500;">
      <div style="width:22px;height:22px;border-radius:50%;background:#004cac;border:none;display:flex;align-items:center;justify-content:center;font-size:11px;color:#fff;">3</div>
      Review
    </div>
    <div style="width:40px;height:1px;background:#ccc;margin:0 4px;"></div>

    <div style="display:flex; align-items:center; gap:6px; font-size:12px; color:#aaa;">
      <div style="width:22px;height:22px;border-radius:50%;border:0.5px solid #ccc;display:flex;align-items:center;justify-content:center;font-size:11px;color:#aaa;">4</div>
      Order
    </div>
...
<div style="background:#004cac; padding:1.5rem; color:#fff;">
  <h1 style="font-size:20px; font-weight:500; margin-bottom:4px; color:#fff;">Setup review</h1>
...
<div style="display:flex; flex-direction:column; gap:1rem;">
  ...
  <div style="background:var(--color-background-primary);border:0.5px solid var(--color-border-tertiary);border-radius:12px;overflow:hidden;">
    ...
    <div style="display:flex;align-items:center;gap:12px;padding:0.75rem 1rem;border-bottom:0.5px solid var(--color-border-tertiary);">
      <div style="width:44px;height:44px;border-radius:8px;background:var(--color-background-secondary);border:0.5px solid var(--color-border-tertiary);display:flex;align-items:center;justify-content:center;font-size:20px;flex-shrink:0;">📦</div>
      <div style="flex:1;min-width:0;">
        <div style="font-size:13px;font-weight:500;color:var(--color-text-primary);"><?= htmlspecialchars($r["name"]) ?></div>
      ...
      <div style="display:flex;align-items:center;gap:16px;text-align:right;">
        <div>
          ...
          <div style="font-size:13px;font-weight:500;"><?= egp($r["unit"]) ?></div>
        </div>
        ...
        <div>
          ...
          <div style="font-size:13px;font-weight:500;color:#004cac;"><?= egp($r["total"]) ?></div>
        </div>
      </div>
    </div>
    <?php endforeach; ?>
...
<div style="position:sticky;top:1rem;display:flex;flex-direction:column;gap:1rem;">
  ...
  <div style="background:var(--color-background-primary);border:0.5px solid var(--color-border-tertiary);border-radius:12px;overflow:hidden;">
    ...
    <div style="display:flex;justify-content:space-between;padding:0.75rem 1rem;border-top:0.5px solid var(--color-border-tertiary);background:var(--color-background-secondary);">
      ...
      <span style="font-size:16px;font-weight:500;color:#004cac;"><?= egp($grandTotal) ?></span>
    </div>
  </div>
